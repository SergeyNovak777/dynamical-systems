...
function main()
    ...
    path_to_save = "/home/sergey/work/repo/dynamical-systems/Tsodyks Markram/Levanova/3 набор параметров/Map LSE/chaos_homoclinic_center"
    cd(path_to_save)
    ...
    range_parameter_2 = range(0.27, 0.264, length = length_range);
