...
function main()
    ...
    path_to_save = "/home/sergey/MEGA/dynamical-systems/Rulkov/data/Maps/with_gamma_broke_first_iter/EEs"
    cd(path_to_save)

    matrix_LSE = load("/home/sergey/MEGA/dynamical-systems/Rulkov/data/Maps/with_gamma_broke_first_iter/LSE_400x400_g_1_g_2.jld2")["λs"]
    matrix_u0 = load("/home/sergey/MEGA/dynamical-systems/Rulkov/data/Maps/with_gamma_broke_first_iter/last_points_400x400_g_1_g_2.jld2")["last_points"]
    matrix_first_point = load("/home/sergey/MEGA/dynamical-systems/Rulkov/data/Maps/with_gamma_broke_first_iter/u0s_400x400_g_1_g_2.jld2")["u0s"]
