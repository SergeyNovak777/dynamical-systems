...
g_start = 10.0; g_end = 0.0; length_range_g = 350;
g1_range = range(g_start, g_end, length_range_g);

vector_LLE = zeros(length_range_g, 15);
vector_u0s = zeros(length_range_g, 15);

u0_first = [1.5, -1.0, -0.5, 2.0, 2.0, 3.0, 1.0, 2.0, 3.0]
#[-1.209552480291383, -2.974892687599158, -1.2093294078516483, -0.0, -2.9067059214835167, -1.209552480291383, -2.974892687599158, -1.2093294078516483, -0.0, -2.9067059214835167, 1.203416761796254, -2.6976364869798553, 1.0532487761090477, -0.0, -0.0]
