...
function main()
    ...
    path_to_save = "/home/sergey/MEGA/dynamical-systems/Rulkov/data/Maps/without_gamma_step_0.1_/"
    cd(path_to_save)
    ...
    range_parameter_1 = range( 0.0, 10.0, step = 0.1);
    range_parameter_2 = range( 0.0, 10.0, step = 0.1);
