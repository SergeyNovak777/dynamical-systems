...
axx1 = Axis(f[1, 1], xlabel = L"time", ylabel = L"x_{1}",
...
save(path_to_save_timeseries*"timeseries_xsum__g1=5_g2=4_k1=0.1_k2=0.05.eps", f)
...
display(GLMakie.Screen(), f);
save(path_to_save_PDF*"PDF__g1=5_g2=4_k1=0.1_k2=0.05.eps", f)
