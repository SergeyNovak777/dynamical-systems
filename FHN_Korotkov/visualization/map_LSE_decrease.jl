...
Λs = load("/home/sergey/MEGA/dynamical-systems/FHN_Korotkov/data/maps_LSE/decrease_g_g=0.08//LSE_350x350_k_1_k_2.jld2")["λs"]

length_range = 350;
k1range = range( 0.0, 0.10, length = length_range);
k2range = range(00.0, 10.0, length = length_range);
