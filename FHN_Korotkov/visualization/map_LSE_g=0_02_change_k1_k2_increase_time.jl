...
Λs = load("/home/sergey/MEGA/dynamical-systems/FHN_Korotkov/data/maps_LSE/g=0.02_change_k1_k_increase_time/LSE_300x300_k_1_k_2.jld2")["λs"]

length_range = 300;
k1range = range( 0.0, 0.15, length = length_range);
