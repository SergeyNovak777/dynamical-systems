...
Λs = load("/home/sergey/MEGA/dynamical-systems/FHN_Korotkov/data/maps_LSE/strip_chaos_zoom/LSE_350x350_k_1_k_2.jld2")["λs"]

length_range = 350;
k1range = range( 0.090, 0.092, length = length_range);
k2range = range(0.0, 0.5, length = length_range);
