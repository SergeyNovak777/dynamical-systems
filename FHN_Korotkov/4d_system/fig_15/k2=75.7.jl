...
t_plot_start =  ttr
t_plot_end = t_plot_start + 20_000;
           
xticks = [-1.13, -0.9, -0.65];
yticks = [-1.12, -0.9, -0.7];
zticks = [-0.635, -0.61, -0.58];
...
ax = Axis3(f[1, 1], xlabel = L"x_1", ylabel = L"x_2", zlabel = L"y_2",
    ...
    xlabeloffset = 60, ylabeloffset = 65, zlabeloffset = 95, protrusions = (30, 30, 120, 30))#,
