...
u0_start = sol[end]#[-1.0836728460611933, -0.6318417392022484, -0.9017528537331925, -0.624049721609583];
...
scatter!(ax, tr[t_plot_start_map:t_plot_end_map, 3], tr[t_plot_start_map:t_plot_end_map, 4],
        markersize = markersize_torus, color = :black);
#= scatter!(ax, fixed_point[3], fixed_point[4], markersize = markersize_fp, color = :red);
text!(ax, fixed_point[3], fixed_point[4],
        text = L"O_1", fontsize = 50, align = (:center, :bottom)) =#

display(GLMakie.Screen(), f);

filename = "route1_g_k2=$(parameters[8]).eps";
path_to_save = "/home/irrito/MEGA2/dynamical_systems/FHN/images/route1/";
