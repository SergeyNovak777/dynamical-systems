...
function main()
    ...
    path_to_save = "/home/sergey/MEGA/dynamical-systems/FHN_Korotkov/data/maps_LSE/g_0_02_from_uni/"
    cd(path_to_save)
    ...
    params[3] = 0.02
    x1, y1, x2, y2  = 1.7,0.3,-0.6,1.0
    u0 = [x1, y1, x2, y2, y1 - y2 ];
    
    length_range = 350;
    range_parameter_1 = range( 0.07, 0.15, length = length_range);
