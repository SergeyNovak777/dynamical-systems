...
function main()
    ...
    path_to_save = "/home/sergey/MEGA/dynamical-systems/FHN_Korotkov/data/maps_LSE/strip_chaos_zoom/"
    cd(path_to_save)
    ...
    length_range = 350;
    range_parameter_1 = range( 0.090, 0.092, length = length_range);
    range_parameter_2 = range(0.0, 0.5, length = length_range);
