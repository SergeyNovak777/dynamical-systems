...
function main()
    ...
    path_to_save = "/home/sergey/MEGA/dynamical-systems/FHN_Korotkov/data/maps_LSE/R3_zoom/"
    cd(path_to_save)
    ...
    length_range = 350;
    range_parameter_1 = range( 0.09075, 0.092, length = length_range);
    range_parameter_2 = range(62.5, 74.0, length = length_range);
