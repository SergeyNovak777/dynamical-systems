...
function main()
    ...
    path_to_save = "/home/sergey/MEGA/dynamical-systems/FHN_Korotkov/data/maps_LSE/change_k2_g_fix_k1/"
    cd(path_to_save)
    ...
    length_range = 350;
    range_parameter_1 = range( 0.1, 0.25, length = length_range);
    range_parameter_2 = range(60.0, 80.0, length = length_range);
