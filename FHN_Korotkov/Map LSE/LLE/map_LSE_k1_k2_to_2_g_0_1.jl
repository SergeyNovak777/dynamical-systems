...
function main()
    ...
    path_to_save = "/home/sergey/MEGA/dynamical-systems/FHN_Korotkov/data/maps_LSE/map_LSE_k1_k2_to_2_g_0_1/"
    cd(path_to_save)
    ...
    range_parameter_2 = range(0.0, 0.2, length = length_range);
