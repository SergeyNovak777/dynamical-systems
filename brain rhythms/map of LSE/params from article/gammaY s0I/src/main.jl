include("C:\\Users\\admin\\Desktop\\dynamical-systems\\brain rhythms\\map of LSE\\params from article\\gammaY s0I\\src\\header.jl");

#include("C:\\Users\\admin\\Desktop\\dynamical-systems\\brain rhythms\\map of LSE\\params from article\\gammaY s0I\\src\\main.jl");
...
function main()
    ...
    for (p2_loc_index, p2_loc) in enumerate(p2_range)
        ...
        ds = init_ds_(rate_model, p, index_control, p2_loc, index_fix, var_fix, u0_lc, integ_set)
